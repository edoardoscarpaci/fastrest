...
router.py
=========
FastAPI router for the notification-hub example.
...
def build_router(
    ...
    """
    Build and return the FastAPI router for the notification-hub example.
    ...
    Edge cases:
        - ``producer._produce()`` propagates Redis errors directly to the
    ...
    async def place_order(body: PlaceOrderRequest) -> dict:
        ...
        asynchronously; delivery to handlers may lag slightly.
        ...
        Raises:
            HTTPException 500: If the Redis publish call fails.
        """
